...
for test_case_id in range(1, NUM_TEST_CASES + 1):
  ...
  for _ in range(1000):
    ...
    if not (prepared_i, prepared_j) in field:
      ...
      print('prepared_cells_count', prepared_cells_count)
      print('edges', southmost, northmost, eastmost, westmost)
      print('required cells', (southmost - northmost + 1) * (eastmost - westmost + 1))
